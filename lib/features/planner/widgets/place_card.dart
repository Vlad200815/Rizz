...
class PlaceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PlannerCard(
      label: '📍 ${LocaleKeys.date_planner_page_where_title.tr()}',
      child: TextFormField(
        onChanged: context.read<PlannerNotifier>().setPlace,
        style: GoogleFonts.dmSans(
          fontSize: 13,
          color: ColorName.purpleTextInput,
        ),
        decoration: InputDecoration(
          hintText: LocaleKeys.date_planner_page_where_hint_text.tr(),
