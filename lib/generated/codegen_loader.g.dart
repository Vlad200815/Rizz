...
class CodegenLoader extends AssetLoader{
  ...
  "date_planner_page": {
    ...
    "to_be_determined_text": "To be determined"
  }
};
static const Map<String,dynamic> _uk = {
  "app": {
    "our_date_title": "Наше побачення"
  },
  "date_request_page": {
    "no_button": "Ні ✗",
    "yes_button": "Так ✓",
  ...
  "date_planner_page": {
    ...
    "note_title": "Нотатка",
    "note_hint_text": "Я буду тою самою дівчиною, яка занадто багато посміхається...",
    ...
    "to_be_determined_text": "Буде визначено"
  }
};
